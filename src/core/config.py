...
def load_scoring_config(path: str) -> ScoringConfig:
    ...
    return ScoringConfig(
        ...
        publisher_blocklist=data.get("publisher_blocklist", d.publisher_blocklist),
        publisher_penalty=data.get("publisher_penalty", d.publisher_penalty),
...
def load_interpret_config(path: str) -> InterpretConfig:
    ...
    return InterpretConfig(
        ...
        cache_ttl_hours=data.get("cache_ttl_hours", d.cache_ttl_hours),
